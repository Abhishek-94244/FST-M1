...
public class Activity2 {
    public static void main(String args[])
    {
       ...
       /* WebDriver driver = new FirefoxDriver();
        driver.get("https://www.training-support.net");
      //  WebElement e  =driver.findElement(By.xpath("//h1[contains(text(),'Training Support')]")).gett
        System.out.print("Page title is :" + driver.getTitle());

        String  e  =driver.findElement(By.xpath("//h1[contains(text(),'Training Support')]")).getText();
        System.out.print(e);
        driver.close();*/
    }
